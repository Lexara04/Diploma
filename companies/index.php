...
$GLOBALS['__NEWS_ID__'] = 0;
?>
<?
global $arFilter1;
if($_GET["fid"]) {
    $arFilter1 = array("PROPERTY" => array("FACULTIES" => $_GET["fid"]));
}
?>
<div class="section section-padding mt-n10">
	...
	Array(
		...
		"DETAIL_FIELD_CODE" => array("DETAIL_TEXT","DETAIL_PICTURE","PREVIEW_PICTURE"),
		"DETAIL_PAGER_SHOW_ALL" => "Y",
		"DETAIL_PAGER_TEMPLATE" => "",
		"DETAIL_PAGER_TITLE" => "Страница",
		"DETAIL_PROPERTY_CODE" => array("FACULTIES",""),
