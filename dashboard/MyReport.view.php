...
require($_SERVER["DOCUMENT_ROOT"]."/dashboard/get_data.php");
    ...
    <div class="row align-items-start mt-3">
        <div class="col-md-9">
            ...
            BarChart::create(array(
                "title" => "Предложения за последний год",
                "dataSource" => $proj_per_month,
                "columns" => array(
                    "year",
            ...
            <?php
            BarChart::create(array(
                "title" => "Предложения за текущий месяц",
