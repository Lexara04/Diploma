...
!function (e, t) {
            ...
            if (o.originalEvent && (o = o.originalEvent), i.isTouched) {
                if (!i.isTouchEvent || "touchmove" === o.type) {
                    ...
                    if (i.allowTouchCallbacks && a.emit("touchMove", o), !(o.targetTouches && o.targetTouches.length > 1)) {
                        ...
                        var c = n.currentX - n.startX, h = n.currentY - n.startY, v;
                        if (!(a.params.threshold && Math.sqrt(Math.pow(c, 2) + Math.pow(h, 2)) < a.params.threshold)) if (void 0 === i.isScrolling && (a.isHorizontal() && n.currentY === n.startY || a.isVertical() && n.currentX === n.startX ? i.isScrolling = !1 : c * c + h * h >= 25 && (v = 180 * Math.atan2(Math.abs(h), Math.abs(c)) / Math.PI, i.isScrolling = a.isHorizontal() ? v > s.touchAngle : 90 - v > s.touchAngle)), i.isScrolling && a.emit("touchMoveOpposite", o), void 0 === i.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (i.startMoving = !0)), i.isScrolling) i.isTouched = !1; else if (i.startMoving) {
        ...
        modular: {
            ...
            updateSize: function () {
                ...
                if (void 0 !== r) {
                    ...
                    if (e.virtualSize = Math.max(e.virtualSize, r) + m, n && l && ("slide" === i.effect || "coverflow" === i.effect) && s.css({width: e.virtualSize + i.spaceBetween + "px"}), i.setWrapperSize && s.css(((z = {})[t("width")] = e.virtualSize + i.spaceBetween + "px", z)), i.slidesPerColumn > 1 && (e.virtualSize = (C + i.spaceBetween) * T, e.virtualSize = Math.ceil(e.virtualSize / i.slidesPerColumn) - i.spaceBetween, s.css(((P = {})[t("width")] = e.virtualSize + i.spaceBetween + "px", P)), i.centeredSlides)) {
                        M = [];
    ...
    var startBuffer = function () {
        var currentBuffer = vid[0].buffered.end(0), maxduration = vid[0].duration,
            perc = 100 * currentBuffer / maxduration;
        $(".bufferBar").css("width", perc + "%"), currentBuffer < maxduration && setTimeout(startBuffer, 500)
    };
    vid.on("timeupdate", (function () {
        var currentPos = vid[0].currentTime, maxduration, perc = 100 * currentPos / vid[0].duration;
    ...
    var updatebar = function (x) {
        var progress = $(".progress"), maxduration = vid[0].duration, position,
    ...
    var updateVolume = function (x, vol) {
        var volume = $(".volume"), percentage, position;
    ...
    var timeFormat = function (seconds) {
        var m = Math.floor(seconds / 60) < 10 ? "0" + Math.floor(seconds / 60) : Math.floor(seconds / 60), s;
