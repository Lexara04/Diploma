...
$arCompanies = [];
$arSelect = array("ID");
$rsCompanies = CIBlockElement::GetList(array(), $filter1, false, false, $arSelect);
...
$rsApplications = CIBlockElement::GetList(array(), $arFilter);
if ($rsApplications): ?>
    ...
    <tbody>
<?while ($arItem = $rsApplications->GetNext()) { ?>
