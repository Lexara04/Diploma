    ...
    <form method="post" action="<?= $arResult["FORM_TARGET"] ?>">
        ...
        <table class="profile-table data-table">
            ...
            <tr>
                ...
                <td><input class="form-control" size="30" type="text" name="SMS_CODE"
                           value="<?= htmlspecialcharsbx($arResult["SMS_CODE"]) ?>" autocomplete="off"/></td>
            </tr>
            </tbody>
        </table>

        <div class="input-group"><input class="form-control" type="submit" name="code_submit_button"
                                        value="<? echo GetMessage("main_profile_send") ?>"/></div>
	...
	<?
                ...
                <? if ($arResult["PHONE_REGISTRATION"]): ?>
                    <tr>
                        ...
                        <td><input class="form-control" type="text" name="PHONE_NUMBER" maxlength="50"
                                   value="<? echo $arResult["arUser"]["PHONE_NUMBER"] ?>"/></td>
                    </tr>
                <? endif ?>
                <? if ($arResult['CAN_EDIT_PASSWORD']): ?>
                    <tr>
                    <td><?= GetMessage('NEW_PASSWORD_REQ') ?></td>
                    <td><input class="form-control" type="password" name="NEW_PASSWORD" maxlength="50" value=""
				...
				<span class="bx-auth-secure" title="<? echo GetMessage("AUTH_NONSECURE_NOTE") ?>">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="password" name="NEW_PASSWORD_CONFIRM" maxlength="50"
        ...
        <div class="input-group">
            ...
            <input class="form-control" type="reset" value="<?= GetMessage('MAIN_RESET'); ?>">
        </div>
        ...
        <? if ($arResult["USER_PROPERTIES"]["SHOW"] == "Y"): ?>
            <div class="profile-link profile-user-div-link"><a title="<?= GetMessage("USER_SHOW_HIDE") ?>"
                                                               ...
                                                               onclick="SectionClick('user_properties')"><?= trim($arParams["USER_PROPERTY_NAME"]) <> '' ? $arParams["USER_PROPERTY_NAME"] : GetMessage("USER_TYPE_EDIT_TAB") ?></a>
            </div>
