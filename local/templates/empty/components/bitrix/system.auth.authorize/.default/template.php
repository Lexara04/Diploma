            ...
            <div class="row">
                <div class="col-lg-5 ">
                    <div class="register-login-images ">
                        <div class="images">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/img/Mobile login-pana.png" alt="Register Login">
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    ...
                    <div class="register-login-form">
                        <h3 class="title">Добро пожаловать, <span>студент!</span> </h3>
...
<?endif?>
			<tr>
				<td></td>
				<td class="authorize-submit-cell"><input class="btn btn-primary w-100 my-6" type="submit" class="btn btn-primary" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" /></td>
			</tr>
		</table>
...
<?if($arParams["NOT_SHOW_LINKS"] != "Y" && $arResult["NEW_USER_REGISTRATION"] == "Y" && $arParams["AUTHORIZE_REGISTRATION"] != "Y"):?>
		<noindex>
			<p class="mt-2">
				Если вы <span class="starrequired">студент</span> и впервые на нашем сайте, зарегистрируйтесь
