...
$subtitleStyle = Utility::get($this->cssStyle, "subtitle");
...
$subtitleClass = Utility::get($this->cssClass, "subtitle");
...
<div id="<?php echo $this->name; ?>" <?php echo ($href)?$href:""; ?>class="koolphp-card card panel<?php echo ($cardClass)?" $cardClass":""; ?>"<?php echo($cardStyle)?" style='$cardStyle'":""; ?>>
    <div class="panel-body card-body">
        ...
        <div class="card-subtitle<?php echo ($subtitleClass)?" $subtitleClass":""; ?>"<?php echo($subtitleStyle)?" style='$subtitleStyle'":""; ?>>
